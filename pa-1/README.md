...
- Git repository URL at git.ajou.ac.kr (10 pts)
  ...
  - Currently, PASubmit only accepts *HTTP + deploy token*. Create a repository at http://git.ajou.ac.kr, create a deploy token from "Settings/Repository/Deploy Tokens", and input the generated token and password. Double check that your repository is private.
